...
import { Sparkles, Layers, Film, Wand2 } from 'lucide-react';
          ...
          <div className={`space-y-8 ${isVisible ? 'animate-fade-up' : 'opacity-0'}`}>
            <div>
              ...
              <h2 className="font-display text-4xl md:text-5xl font-bold leading-tight mb-6">
                From VFX Pioneer to
                <span className="text-gradient block">AI Visionary</span>
              </h2>
            </div>

            <div className="space-y-6 font-body text-muted-foreground leading-relaxed">
              <p>
                With over 15 years in visual effects, I've had the privilege of working on 
                blockbuster films that have captivated audiences worldwide. From intricate 
                compositing work to leading VFX teams, my journey has been defined by an 
                relentless pursuit of visual excellence.
              </p>
              <p>
                Today, I'm pioneering the integration of AI into filmmaking—leveraging 
                tools like Midjourney, Runway, and Sora to create imagery that was 
                once impossible. My VFX background gives me a unique edge: I understand 
                both the art and the technique.
              </p>
            </div>
            ...
            <div className="grid grid-cols-2 gap-6 pt-6 border-t border-border">
              ...
              <div>
                <p className="font-display text-3xl md:text-4xl font-bold text-gradient">15+</p>
          ...
          <div className={`${isVisible ? 'animate-fade-up delay-300' : 'opacity-0'}`}>
            <div className="grid grid-cols-2 gap-4">
              {skills.map((skill, index) => (
                ...
                >
                  ...
                  <skill.icon className="w-10 h-10 text-primary mb-4 transition-transform duration-300 group-hover:scale-110" />
            ...
            <div className="mt-8 p-6 bg-secondary/30 rounded-2xl border border-border">
              ...
              <div className="flex flex-wrap gap-2">
                {['Nuke', 'After Effects', 'Houdini', 'Runway', 'Midjourney', 'Sora', 'ComfyUI', 'DaVinci'].map((tool) => (
                  <span
                    key={tool}
